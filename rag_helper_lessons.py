"""Modified RAG helper for LLM Zoomcamp 2026 - Homework 1 (Agentic RAG).

Adapts the FAQ-schema RAGBase to our lessons schema (filename / content),
and makes rag() return both the answer and the token usage (Q3 requirement).
"""
